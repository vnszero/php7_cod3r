<nav class="modules">
    ...
    <div class="module green">
        ...
        <ul>
            <li><a href="exercice.php?dir=error_handling&file=try_catch">Try & Catch</a></li>
            <li><a href="exercice.php?dir=error_handling&file=custom_errors">Erros Personalizados</a></li>
            <li><a href="exercice.php?dir=error_handling&file=intdiv_challenge">Desafio intdiv</a></li>
            <li><a href="exercice.php?dir=error_handling&file=error_handler">Error Handler</a></li>
        </ul>
    </div>
    <div class="module green">
        <h3>10. Namespace</h3>
    ...
    <div class="module green">
        ...
        <ul>
            ...
            <li><a href="exercice.php?dir=includes&file=include_funcao">Include por Função</a></li>
            <li><a href="exercice.php?dir=includes&file=include_require">Include vs Require</a></li>
            <li><a href="exercice.php?dir=includes&file=require_return">Require & Return</a></li>
            <li><a href="exercice.php?dir=includes&file=once">Include e Require Once</a></li>
            <li><a href="exercice.php?dir=includes&file=include_challenge">Desafio Include</a></li>
        </ul>
    </div>
    <div class="module green">
